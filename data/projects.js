export const projects = [
    ...
    },
    {
        ...
        stack: [
            {name: 'React Native'}, {name: 'AI/ML'}, {name: 'Natural Language Processing'}, {name: 'Sentiment Analysis'}
        ], 
    ...
    },
    {
        ...
        stack: [
            {name: 'Python'}, {name: 'TensorFlow'}, {name: 'LSTM'}, {name: 'FastAPI'}, {name: 'Docker'}, {name: 'AWS ECS'}, {name: 'Quantitative Finance'}
        ], 
    ...
    },
    {
        ...
        stack: [
            {name: 'React'}, {name: 'Node.js'}, {name: 'MongoDB'}, {name: 'Express'}, {name: 'Socket.io'}, {name: 'Education Technology'}
        ], 
    ...
    },
    {
        ...
        stack: [
            {name: 'Django'}, {name: 'Docker'}, {name: 'Railway'}, {name: 'JavaScript'}, {name: 'NGINX'}, {name: 'PostgreSQL'}, {name: 'CSS'}
        ], 
    ...
    },
    {
        ...
        stack: [
            {name: 'React'}, {name: 'Node.js'}, {name: 'MySQL'}, {name: 'Express'}, {name: 'Point of Sale'}, {name: 'Inventory Management'}
        ], 
    ...
    },
    {
        ...
        stack: [
            {name: 'Python'}, {name: 'TensorFlow'}, {name: 'NLP'}, {name: 'Deep Learning'}, {name: 'Educational AI'}, {name: 'TF-IDF'}
        ], 
    ...
    },
    {
        ...
        stack: [
            {name: 'Python'}, {name: 'TensorFlow'}, {name: 'Neural Style Transfer'}, {name: 'Computer Vision'}, {name: 'CNN'}
        ], 
    ...
    },
    {
        ...
        stack: [
            {name: 'Python'}, {name: 'TensorFlow'}, {name: 'YOLO'}, {name: 'Computer Vision'}, {name: 'Object Detection'}
        ], 
    ...
    },
    {
        ...
        stack: [
            {name: 'Python'}, {name: 'TensorFlow'}, {name: 'LSTM'}, {name: 'Music Generation'}, {name: 'Creative AI'}
        ], 
